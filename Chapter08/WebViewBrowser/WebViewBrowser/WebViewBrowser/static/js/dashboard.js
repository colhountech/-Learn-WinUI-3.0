    ...
    <div class="col-12 col-xl-4 col-lg-4 col-md-6 mb-4 mb-lg-0">
        ...
        <div class="card">
            <div id="card-severity-chart" class="card-body">
                <p class="card-title card-title-upper card-title-bold">severity</p>
    ...
    <div class="col-12 col-xl-8 col-lg-8 col-md-6 mb-4 mb-lg-0">
        <div class="card">
            <div id="card-categories-chart" class="card-body">
                <p class="card-title card-title-upper card-title-bold">categories</p>
...
function generateAggregateSummaryCard() {
    let cardHTML = '<p class="card-title card-title-upper card-title-bold">summary</p>';
    ...
    cardHTML += 
        `<div>
            ...
            <span id="SummaryReportEntries" class="card-text">projects</span>
        </div>
        <div>
            <h3 class="card-text card-main-content">${issuesCount}</h3>
            <span class="card-text">issues</span>
        ...
        <div>
            ...
            <span class="card-text">incidents</span>
        ...
        <div>
            ...
            <span class="card-text">story points</span>
