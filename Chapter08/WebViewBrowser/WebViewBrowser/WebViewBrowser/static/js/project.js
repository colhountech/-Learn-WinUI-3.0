...
<div>
    <div style="margin-bottom: 15px">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active project-tab" aria-current="page" href="#" id="project-tab-dashboard">Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link project-tab" href="#" id="project-tab-components">Components</a>
            </li>
            <li class="nav-item">
                <a class="nav-link project-tab" href="#" id="project-tab-issues">Issues</a>
            </li>
        </ul>
    </div>
